...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ayatView',
          path: '/ayatView',
          builder: (context, params) => AyatViewWidget(
            nomorSurah: params.getParam('nomorSurah', ParamType.int),
            namaSurah: params.getParam('namaSurah', ParamType.String),
            tempatTurun: params.getParam('tempatTurun', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'Quiz',
        ...
        FFRoute(
          name: 'Game-Mukmeen',
          path: '/gameMukmeen',
          builder: (context, params) => GameMukmeenWidget(),
        ),
        FFRoute(
          name: 'Game',
          path: '/game',
        ...
        FFRoute(
          name: 'surahView',
          path: '/surahView',
          builder: (context, params) => SurahViewWidget(),
        ),
        FFRoute(
          name: 'surahView-rev',
          path: '/surahViewRev',
          builder: (context, params) => SurahViewRevWidget(),
        ),
        FFRoute(
          name: 'Quiz-1',
          path: '/quiz1',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/dis@720p-60fps.gif',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
